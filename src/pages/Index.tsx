...
const Index = () => {
  ...
  return <Layout>
      {/* Hero Section */}
      <section className="relative overflow-hidden py-20" style={{backgroundImage: `url('/lovable-uploads/c77b8985-b3ed-4614-9086-c2eac14a2227.png')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
